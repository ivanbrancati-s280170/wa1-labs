...
const TaskControls = (props) => {
    return (
            <p>
                ...
                <svg onClick={()=>console.log("ClickDelete")}xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash text-danger" viewBox="0 0 16 16">
