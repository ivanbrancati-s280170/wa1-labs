    ...
    return (<ListGroup.Item className="tasklist-elem mylistmain" key={props.task.id}>
                <div className="d-flex w-100 justify-content-between pt-1">
                    ...
                    <div className="d-flex w-25 justify-content-end">
                        <TaskControls id={props.task.id} removeTask={props.removeTask}/>
                    </div>
                </div>
            </ListGroup.Item>) ;
} ;
...
const TaskControls = (props) => {
    return (
            <p>
                {/*TODO: onclick for editing task*/}
                <svg onClick={()=>console.log("Click")} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-fill text-warning" viewBox="0 0 16 16">
...
const ToDoTaskList = (props) => {
    return (
            <ListGroup as="ul" variant="flush" className="tasklist">
                { props.elements.map( (e) => <TaskRow task={e} key={e.id} removeTask={props.removeTask}/>)}
            </ListGroup>
            ) ;
} ;
    ...
    return (
            <Col as='main' xs={12} sm={8}>
                <div id="tasklist-container">
                    ...
                    <ToDoTaskList elements={props.tasks} removeTask={props.removeTask}></ToDoTaskList>
